    ...
    var getPreviewContent = function (editor, html) {
      if (html.indexOf('<html>') === -1) {
        ...
        global$1.each(editor.contentCSS, function (url) {
          contentCssEntries_1 += '<link type="text/css_admin" rel="stylesheet" href="' + editor.documentBaseURI.toAbsolute(url) + '"' + cors_1 + '>';
        });
        if (contentStyle) {
          contentCssEntries_1 += '<style type="text/css_admin">' + contentStyle + '</style>';
        }
