...
(function () {
    ...
    var getPreviewHtml = function (editor) {
      ...
      global$2.each(editor.contentCSS, function (url) {
        headHtml += '<link type="text/css_admin" rel="stylesheet" href="' + encode(editor.documentBaseURI.toAbsolute(url)) + '"' + cors + '>';
      });
      if (contentStyle) {
        headHtml += '<style type="text/css_admin">' + contentStyle + '</style>';
      }
