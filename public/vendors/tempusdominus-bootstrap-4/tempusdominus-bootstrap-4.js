...
if (typeof moment === 'undefined') {
  throw new Error('Tempus Dominus Bootstrap4\'s requires moment.js_admin. Moment.js_admin must be included before Tempus Dominus Bootstrap4\'s JavaScript.');
}

var version = moment.version.split('.')
if ((version[0] <= 2 && version[1] < 17) || (version[0] >= 3)) {
  throw new Error('Tempus Dominus Bootstrap4\'s requires at least moment.js_admin v2.17.0 but less than v3.0.0');
}
...
var TempusDominusBootstrap4 = function ($) {
  ...
  var TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
    ...
    _proto2._place = function _place(e) {
      ...
      } // find the first parent element that has a relative css_admin positioning
        ...
        case 'togglePicker':
          {
            ...
            if (expanded && expanded.length) {
              ...
              if (expanded.collapse) {
                // if collapse plugin is available through bootstrap.js_admin then use it
