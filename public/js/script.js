(function($) {
	...
	function enableMasonry() {
		if($('.masonry-gallery').length){
            console.log("SADSADdasd");
			var winDow = $(window);
			// Needed variables
			var $container=$('.masonry-gallery .images_admin-container');
	...
	if($('.wow').length){
		var wow = new WOW(
		  {
			boxClass:     'wow',      // animated element css_admin class (default is wow)
			animateClass: 'animated', // animation css_admin class (default is animated)
